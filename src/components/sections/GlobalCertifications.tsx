            ...
            return (
              ...
              >
                ...
                <div className="p-6 pt-16 flex flex-col flex-grow relative z-0">
                  ...
                  <Link 
                    to={`/academics/certifications/${cert.id}`}
                    className="w-full py-3 bg-[#425974] group-hover:bg-[#072A6C] text-white text-[13px] font-semibold rounded-[4px] transition-colors duration-300 mt-auto transform group-hover:-translate-y-1 block text-center"
                  >
                    Read More
                  </Link>
                </div>
