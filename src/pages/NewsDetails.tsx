...
// Image sets mapping for each News article slug
const NEWS_IMAGES_MAP: Record<string, string[]> = {
  "ai-research-lab": [
    "/prog_computer.png",
...
function ImageSlider({ images }: { images: string[] }) {
  ...
  return (
    <div 
      className="relative w-full h-[300px] md:h-[500px] rounded-[18px] overflow-hidden shadow-sm select-none bg-gray-100"
    ...
    <div className="min-h-screen bg-[#F7F9FC] py-10 font-[var(--font-poppins)] relative text-left">
      <div className="max-w-[1100px] mx-auto px-5">
        ...
        <div className="bg-white rounded-[18px] overflow-hidden shadow-sm border border-gray-100/80 p-6 md:p-10 space-y-6">
          ...
          {/* Large Hero Image replaced with premium ImageSlider */}
